...
var addProduct = function addProduct(_ref) {
  var name, description, price, quantity, image, categoryId, formData, response;
  return regeneratorRuntime.async(function addProduct$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          name = _ref.name, description = _ref.description, price = _ref.price, quantity = _ref.quantity, image = _ref.image, categoryId = _ref.categoryId;
  ...
  return regeneratorRuntime.async(function updateProduct$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          name = _ref2.name, description = _ref2.description, price = _ref2.price, quantity = _ref2.quantity, image = _ref2.image, categoryId = _ref2.categoryId;
          formData = new FormData();
          formData.append("name", name);
          formData.append("description", description);
          formData.append("price", price);
